...
$$ \sigma_{x}^2 = var(x) = \frac{\sum\limit_{i=1}^{n} (x - \bar{x})^2}{n-1} $$
...
$$ \sigma_x = \sqrt{\frac{\sum\limit_{i=1}^{n}(x - \bar{x})^2}{n-1}} $$
...
$$ cov(x, y) = \sum\limits_{i=1}^{n}\frac{(x_i - \bar{x}) (y_i - \bar{y})} {n - 1} $$
...
$$  \rho_{x,y} = \frac{\sum\limits_{i=1}^{n}(x_i-\bar{x})(y_i-\bar{y})}{\sqrt{\sum\limits_{i=1}^n(x_i-\bar{x})^2\sum\limits_{i=1}^n(y_i-\bar{y})^2}} $$
