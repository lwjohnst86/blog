...
cat(readLines('../images/file_structure.txt', warn = FALSE), sep = '\n')
```
...
prodigenr ([`vignette('introduction')`](https://htmlpreview.github.io/?https://github.com/lwjohnst86/prodigenr/blob/master/vignettes/introduction.html) from version `r packageVersion('prodigenr')`).
